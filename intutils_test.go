...
testing 包为提供了编写单元测试所需的工具，
写好单元测试后，我们可以通过 go test 命令运行测试。*/

/*为方便演示，例子的代码位于 main 包，
实际上，单元测试的代码可以位于任何包下。
...
testing 运行器多次执行每个基准测试函数，
并在每次运行时增加 b.N， 直到它收集到精确的测量值。*/
...
/*go test -v
go test -bench=.*/
/*PS D:\GolandProjects\gobyexample> go test -v  .\intutils_test.go
=== RUN   TestIntMinBasic
...
--- PASS: TestIntMinTableDriven (0.00s)
    ...
    --- PASS: TestIntMinTableDriven/-1,0 (0.00s)
PASS
ok      command-line-arguments  0.549s
*/

/*PS D:\GolandProjects\gobyexample\danyuanceshi> go test -bench=.\intutils_test.go
