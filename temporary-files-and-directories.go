...
func main() {
	...
	函数的第一个参数传 ""，
	os.CreateTemp 会在操作系统的默认位置下创建该文件。*/
	...
	//Temp file name:  C:\Users\SHIBIN~1\AppData\Local\Temp\sample3345640415
	...
	//Temp dir name:  C:\Users\SHIBIN~1\AppData\Local\Temp\sampledir3130410951
